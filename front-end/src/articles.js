export const articles = [
  {
    ...
    "images": [
      'https://resources.esportsinsider.com/esportsinsider/2020/03/20191206_Helena-Kristiansson_EPL-Odense_02037-e1580495132386.png',
  ...
  },
  {
    ...
    "are, quite simply, mind-blowing. It was just months ago that Gamers8 "+
    "wrapped up in Riyadh, having made history as the largest event of its kind "+
    "in the history of the esports ecosystem. Now, Saudi Arabia’s Prime Minister, "+
    "HRH Mohammed bin Salman bin Abdulaziz has unveiled plans for an annual Esports "+
    "World Cup event. It’s going to replace Gamers8, which has only taken place twice "+
    "but has rapidly grown to become known as one of the most valuable esports "+
    "events on Earth. In the social media posts that revealed the Esports World Cup in "+
    "Riyadh, it was stated that it’ll be the ‘world’s largest esports event’ when it takes "+
    "place for the first time next summer. Many industry personalities and experts have found issues "+
    "and concerns with Saudi Arabia’s aggressive deep-dive into esports, but there’s no doubting the appeal of these events.",
    "images": [
      'https://resources.esportsinsider.com/esportsinsider/2023/01/Screenshot-2023-01-26-at-12.32.31-min.png',
      'https://cdn.dmcl.biz/media/image/250401/o/Gamers8.jpg'
    ],
    "tags": ['ESports-Events']
  },
  {
    ...
    "description": "The recent expansion of Counter-Strike 2 saw the formation of several new teams, " +
      ...
      "how these teams will perform in upcoming tournaments and whether they can challenge the established giants.",
    "images": [
      'https://www.betus.com.pa/wp-content/uploads/2023/08/valve-reportedly-looks-to-end-partnerships-by-2025-to-open-up-cs2-competitive-scene-08-03-2023.webp',
      'https://resources.esportsinsider.com/esportsinsider/2023/03/Screenshot-2023-03-22-at-18.19.55.png'
    ],
    "tags": ['Counter-Strike 2', 'ESports-News']
  },
  {
    "id": 3,
    ...
    "description": "Mobile esports is experiencing a surge in popularity across Asia, with millions of players " +
      ...
      "attracting a diverse audience and creating new opportunities for players and organizations.",
    "images": [
      'https://www.transperfect.com/sites/default/files/styles/responsive_image_2000/public/media/image/shutterstock_1934243669.png?itok=h3wCXO4A',
      'https://gumlet.assettype.com/afkgaming%2F2022-12%2F1f42e7d4-fe78-4ab4-9692-e83b33151a24%2FCover_Image___JONATHAN_Comes_Second_For_Esports_Mobile_Player_Of_The_Year_At_Esports_Awards_2022.jpg?compress=true&dpr=1&w=1200'
    ],
    "tags": ['Mobile Esports', 'Asia', 'ESports-News']
  },
  {
    "id": 4,
    ...
    "images": [
      'https://cs2.eu/wp-content/uploads/2023/10/cs2-strategy-2.webp'
    ],
    "tags": ['Counter-Strike 2', 'ESports-Analysis']
  },
  {
    "id": 5,
    ...
    "images": [
      'https://www.geo.tv/assets/uploads/updates/2023-10-23/515724_9306448_updates.jpg',
      'https://s.hdnux.com/photos/01/30/17/62/23133314/3/rawImage.jpg'
    ],
    "tags": ['ESports World Cup', 'ESports-Events']
  },
  {
    "id": 6,
    ...
    "images": [
      'https://www.fifa.gg/assets/images/final/fifa_e_finals_2023_main_bg.jpg'
    ],
    "tags": ['Saudi Arabia', 'ESports-Arenas']
  }
];
